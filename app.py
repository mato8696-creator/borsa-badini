...
translations = {
    "Kurdish": {
        "title": "بۆڕسا دهۆک یا جیهانی", "usd_live": "بهایێ دۆلاری (١٠٠$)", "news": "⚠️ هایداری: بهایێ بازارێ دهۆک یێ جێگیر نینە",
        "usd_calc": "💵 گوهۆڕینا دۆلاری", "res": "ئەنجام ب دینار:", "tele": "کەنالێ تێلەگرامی", "btn": "حساب بکە (Enter)"
    },
    "Arabic": {
        "title": "بورصة دهوك العالمية", "usd_live": "سعر الدولار (١٠٠$)", "news": "⚠️ تنبيه: أسعار سوق دهوك غير مستقرة",
        "usd_calc": "💵 تحويل الدولار", "res": "النتيجة بالدينار:", "tele": "قناة التيليجرام", "btn": "تحويل"
    },
    "English": {
        "title": "Duhok Global Borsa", "usd_live": "USD Rate (100$)", "news": "⚠️ Notice: Duhok market rates are unstable",
        "usd_calc": "💵 USD Converter", "res": "Result in IQD:", "tele": "Telegram Channel", "btn": "Calculate"
    }
}
t = translations[st.session_state.language]

# 5. ستایلێ ناوخۆیی (پاشخان و دیزاین)
...
# 8. شاشا سەرەکی (پشتی زمان دهێتە هەلبژارتن)
