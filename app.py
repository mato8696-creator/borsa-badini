...
# 6. وەرگرتنا نرخێ دۆلاری یێ ئۆتۆماتیکی
try:
...
# نیشاندانا کارتا دۆلاری ب تەنێ
st.markdown(f"""
<div class="card">
    <p>{t['usd']}</p>
    <h1 style="color: #00FF00 !important; font-size: 55px; margin:0;">{iqd_100:,.0f}</h1>
</div>
""", unsafe_allow_html=True)
