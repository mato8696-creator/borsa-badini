...
# 1. ڕێکخستنا لاپەڕەی و نووکرنا خۆدکار
...
# 2. مێمۆری بۆ زمان، بینەران، و حسابکەرێ
...
# 4. وەرگێڕان
text = {
    "KU": {"u": "بهایێ دۆلاری (١٠٠$)", "c": "حسابکەرا پارەی", "v": "بینەرێن حەقیقی:", "btn": "Enter"},
    "AR": {"u": "سعر الدولار (١٠٠$)", "c": "حاسبة العملات", "v": "الزوار الحقيقيون:", "btn": "تحويل"}
}[st.session_state.lang]

# 5. ستایل و وێنەیێ دۆلاری یێ مەزن ل پشت نڤیسینان
# ئەڤە لینکێ وێنەیەکێ کوالێتی بلند یێ دۆلاری یە
...
<style>
    ...
    .price-card {{ background: rgba(20,20,20,0.9); padding: 30px; border-radius: 20px; border: 2px solid #bf953f; text-align: center; }}
    h1 {{ color: #00FF00 !important; font-size: 55px !important; font-weight: bold; }}
    p, label {{ color: white !important; }}
</style>
""", unsafe_allow_html=True)

# 6. نرخێ ئۆتۆماتیک یێ دهۆک
try:
