...
translations = {
    "Kurdish": {
        "title": "بۆڕسا دهۆک یا جیهانی", "usd_live": "بهایێ دۆلاری (١٠٠$)", "news": "⚠️ هایداری: بهایێ بازارێ دهۆک یێ جێگیر نینە.. دەمژمێر ب دەمژمێر نوو د بيته فه",
    ...
    "English": {
        "title": "Duhok Global Borsa", "usd_live": "USD Rate (100$)", "news": "⚠️ Notice: Duhok market rates are unstable.. updating hour by hour",
...
# 6. شریتێ نووچەیان یێ لڤۆک (Marquee)
...
# 10. دوکمێن پەیوەندیێ
st.markdown(f'<a href="https://wa.me/9647503233348" style="display:block; background:#25D366; color:white; text-align:center; padding:15px; border-radius:12px; text-decoration:none; font-weight:bold; margin-top:20px; border:1px solid #fff;">💬 واتسئاپ</a>', unsafe_allow_html=True)
